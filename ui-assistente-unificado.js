/* OPERA ONE V16.1 — interface única, áudio único e sem duplicações */
(function(){'use strict';
const base='?v=16.1.0';
...
function cleanup(){
 const css=document.createElement('style');css.id='opera-one-v161-cleanup';css.textContent='.more-tools .tools-wrap>main>section.card:first-child{display:none!important}#voiceV9,#voiceV8,#operaVoicePanel,#voiceBtn,#voiceStatus,#operaPrimaryAudio,#operaPrimaryAudioBtn,#operaPrimaryAudioStatus{display:none!important}.assist-home .assist-command>button{display:none!important}.assist-home .opera-main-input-tools{display:grid!important}.assist-home .opera-launch-result{display:block!important}';document.head.appendChild(css);
