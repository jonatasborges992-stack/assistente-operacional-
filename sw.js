const CACHE='opera-one-app-v934';
...
async function responseWithModules(req){
  ...
  if(req.destination==='document'||type.includes('text/html')){
    ...
    const tags=[
      '<script src="./audio-launcher-v1.js?v=3"></script>',
      '<script src="./opera-intelligence.js?v=3"></script>',
      '<script src="./opera-intelligence-core.js?v=3"></script>',
      '<script src="./opera-intelligence-entities.js?v=3"></script>',
      '<script src="./opera-intelligence-parser.js?v=3"></script>',
      '<script src="./opera-intelligence-ui.js?v=3"></script>'
    ];
